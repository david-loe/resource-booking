    ...
    <div v-if="rooms.length > 0">
      <div class="container my-3">
        <div class="row justify-content-center">
          <div class="col-9">
            <div class="list-group list-group-checkable d-flex flex-wrap flex-row bg-light p-2">
              <div v-for="(room, index) of rooms" v-bind:key="room.name" class="ps-2">
                <input
      ...
      <Calendar :roomNames="this.roomNames" tab="month" v-on:changed-events="this.$emit('changed-events')"></Calendar>
    </div>
