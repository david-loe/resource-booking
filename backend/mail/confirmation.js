...
function sendConformationMail(startDate, endDate, roomNames, summary, roomService, recipientName, recipientMail) {
    ...
    const htmlText = `
        ...
        </h1> </td> </tr> <tr> <td> <table id="content"> <tr> <td> <p>` + i18n.t("mail.confirmation.salutation", { recipient: recipientName }) + `
        ...
        </td> </tr> </table> </td> </tr> <tr> <td id="footer"> ` + i18n.t("mail.confirmation.footer") + `
    ...
    const plainText = i18n.t("mail.confirmation.heading") + '\n\n' +
        i18n.t("mail.confirmation.salutation", { recipient: recipientName }) + '\n' +
