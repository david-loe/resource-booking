...
resourceNameMatch = [
    /^(?!service\b)[^<>\/\\\*\|":\?]*$/,
    "Name can not contain: ^<>/\\*|\":? \n Name can not be: 'service'."
]


const resourceSchema = new mongoose.Schema({
    name: { type: String, unique: true, required: true, match: resourceNameMatch },
    size: { type: String },
    description: { type: String, default: 'A Resource.' },
    ...
    subresources: { type: Array(String), default: [] },
